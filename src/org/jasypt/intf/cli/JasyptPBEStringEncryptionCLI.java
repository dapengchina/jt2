...
public final class JasyptPBEStringEncryptionCLI {
    ...
    public static void main(String[] args) {
    	String[] temp={"input=f9a7eCE47d094316B249cD443F1C41ea","password=FLY12jkaprG@","algorithm=PBEWithHmacSHA512AndAES_128","ivGeneratorClassName=org.jasypt.iv.RandomIvGenerator","providerName=SunJCE","saltGeneratorClassName=org.jasypt.salt.RandomSaltGenerator","stringOutputType=base64"};
        args=temp;
